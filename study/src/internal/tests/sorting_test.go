...
func TestQuickSort_BestCase(t *testing.T) {
	a := []int {0, 1, 2, 3, 4, 5, 6}

	if !sortingAlgorithms.IsSorted(sortingAlgorithms.QuickSort(a)) {
		t.Fail()
	}
}

func TestQuickSort_WorstCase(t *testing.T) {
	a := []int {9, 8, 7, 6, 5, 4, 3, 2, 1}
...
func TestQuickSort_Average(t *testing.T) {
	a := []int {5, 1, 2, 10, 3, 4, 20, 50, 0}
